...
const styles: Record<string, React.CSSProperties> = {
  ...
  accessRowHit: { backgroundColor: "#e9f2dd", borderColor: "#3f681b" },
  accessRowMiss: { backgroundColor: "#fef2f2", borderColor: "#7f1d1d" },
  ...
  resultBadge: { fontWeight: 600, fontSize: "0.85rem", color: "#aaa" },
  hitText: { color: "#3f681b" },
  missText: { color: "#7f1d1d" },
  ...
  hitBtn: {
    ...
    padding: "10px 0",
    borderRadius: 8,
    backgroundColor: "#e9f2dd",
    color: "#3f681b",
    fontWeight: 600,
    fontSize: "0.95rem",
    border: "1px solid #3f681b",
    cursor: "pointer",
    maxWidth: 260,
  },
  missBtn: {
  ...
  feedbackCorrect: { backgroundColor: "#E6F1FB", border: "1px solid #195FA5", color: "#195FA5" },
  feedbackIncorrect: { backgroundColor: "#FEF9E0", border: "1px solid #B6761D", color: "#B6761D" },
  feedbackTitle: { fontWeight: 700, fontSize: "0.9rem", marginBottom: 4},
